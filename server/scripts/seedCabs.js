...
const cabTemplates = [
    ...
    { vehicleName: "Toyota Innova Crysta", vehicleType: "SUV", operator: "TravelGO Premium", basePrice: 1200, pricePerKm: 18, capacity: 6, amenities: ["AC", "Carrier", "Professional Driver", "Magazine"], fuelType: 'Diesel', transmission: 'Manual', tags: ["High Comfort"] },
