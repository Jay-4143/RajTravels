/**
 * Package Controller
 * Domestic/International packages, details, inquiry
 */
...
/**
 * @desc    Get packages (domestic or international)
 * @route   GET /api/packages
 * @access  Public
 */
exports.getPackages = async (req, res, next) => {
  try {
    const { type, destination, minPrice, maxPrice, sort = 'price', order = 'asc', page = 1, limit = 20 } = req.query;
