...
import VisaPopularDestinations from "../components/visa/VisaPopularDestinations";
...
const VisaPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col pt-16">
      ...
      <VisaHero setSearchResults={setSearchResults} setLoading={setLoading} />
      {/* Search Results Section (Conditionally Rendered) */}
      {loading && (
        <div className="py-12 text-center">
          <div className="inline-block animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-blue-600"></div>
          <p className="mt-2 text-gray-600">
            Searching specifically for you...
          </p>
        </div>
      )}
      {searchResults && (
              ...
              {searchResults.map((visa) => (
                ...
                >
                    ...
                    {visa.images && visa.images[0] ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.src =
                            "https://images.unsplash.com/photo-1549317661-bd32c8ce0729?w=400";
                        }}
                      />
                    ) : (
                  ...
                  <div className="p-6">
                    ...
                    <button
                      onClick={() =>
                        (window.location.href = `/visa/${visa._id}`)
                      }
